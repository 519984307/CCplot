    ...
    , ui(new Ui::CCPlotLayout)
{
    ...
    QGridLayout* gl1 = new QGridLayout(ui->widget_canvas);
    gl1->setMargin(0);
...
void CCPlotLayout::showSetBar(bool flag)
{
    if(flag)
        ui->groupBox->show();
    else
...
void CCPlotLayout::btn_choose_clicked()
{
...
void CCPlotLayout::on_btn_choose_clicked()
{
    btn_choose_clicked();
}
